...
namespace N11TestProject
{
    class MainPage
    {
        ...
        public IWebElement bilgisayarControl;

        [FindsBy(How = How.CssSelector, Using = "h3.productName")]
        public IWebElement productName;

        [FindsBy(How = How.XPath, Using = ".//*[@id='contentListing']/div/div/div[2]/div[4]/a[2]")]
        ...
        [FindsBy(How = How.XPath, Using = ".//*[@id='contentListing']/div/div/div[2]/section/div[2]/ul/li[3]/div/div[1]/a/h3")]
        public IWebElement addFavoriteText;

        [FindsBy(How = How.XPath, Using = ".//*[@id='contentListing']/div/div/div[2]/section[1]/div[2]/ul/li[3]/div/div[2]/span")]
